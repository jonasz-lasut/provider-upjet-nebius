...
type InventoryInitParameters struct {
	...
	DestinationBucketIDRef *v2.Reference `json:"destinationBucketIdRef,omitempty" tf:"-"`

	// Selector for a Bucket in storage to populate destinationBucketId.
	// +kubebuilder:validation:Optional
	DestinationBucketIDSelector *v2.Selector `json:"destinationBucketIdSelector,omitempty" tf:"-"`
